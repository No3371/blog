...
Let's perform the above technique on `int.MinValue`, -2147483648, which is 1000 0000 0000 0000 0000 0000 0000 0000.
...
So the value is possibliy `int.MinValue`, we have to avoid this trick.

Also, this does not necessarily makes your program gaster because modern compiler is good at optimization, it's often faster then manual optimization.
